  ...
  try {
    ...
    const r = getDb().prepare(`INSERT INTO proxy_templates
      (name, description, check_mode, check_start_time, check_window_time, check_min_interval,
       check_distribution, check_stop_after_found_count, check_greedy_spread_window, check_reuse_channel,
      ...
      check_greedy_spread_window: b.check_greedy_spread_window != null ? parseInt(b.check_greedy_spread_window) : 30000,
...
router.put('/:id', (req, res) => {
  try {
    ...
    db.prepare(`UPDATE proxy_templates SET
      ...
      check_greedy_spread_window = COALESCE(@check_greedy_spread_window, check_greedy_spread_window),
      ...
      check_greedy_spread_window: b.check_greedy_spread_window != null ? parseInt(b.check_greedy_spread_window) : null,
